 ...
 */
export default class PackagePanel {
    /**
     * Track the currently panel. Only allow a single panel to exist at a time.
     */
    public static currentPanel: PackagePanel | undefined;

    public static readonly viewType = 'npmPackage';
    ...
    public static createOrShow(extensionPath: string) {
        ...
        if (PackagePanel.currentPanel) {
            PackagePanel.currentPanel._panel.reveal(column);
            return;
        }

        // Otherwise, create a new panel.
        const panel = vscode.window.createWebviewPanel(PackagePanel.viewType, "Cat Coding", column || vscode.ViewColumn.One, {
        ...
        PackagePanel.currentPanel = new PackagePanel(panel, extensionPath);
    }
